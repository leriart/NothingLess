...
This adds `source = ~/.local/share/nothingless/hyprland.conf` to your Hyprland config.
The file is auto-generated by NothingLess with your current compositor settings (borders, gaps, rounding, etc.).
